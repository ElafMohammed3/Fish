...
=======
CATEGORY_URL = "https://ar.wikipedia.org/wiki/%D8%AA%D8%B5%D9%86%D9%8A%D9%81:%D8%A3%D8%B3%D9%85%D8%A7%D9%83_%D8%A7%D9%84%D8%A8%D8%AD%D8%B1_%D8%A7%D9%84%D8%A3%D8%AD%D9%85%D8%B1"
# --------------------------------------------------
DB = {
    "host": os.getenv("DB_HOST", "localhost"),
    "user": os.getenv("DB_USER", "root"),
...
# ------------------------------------------------
HEADERS = {
    "User-Agent": "Edu_Fish_project (+https://yourdomain.com/info) - Educational use; data will be documented",
>>>>>>> 78a53505a3407e2ea0e613797b38aa492af9e022
...
=======
def get_article_links(category_url, max_links=52):
    """Return full article URLs found in a Wikipedia category page (no namespace links)."""
    links = []
    try:
...
def run(category_url, limit=10):
    print("Fetching links from category...")
    links = get_article_links(category_url, max_links=52)
>>>>>>> 78a53505a3407e2ea0e613797b38aa492af9e022
